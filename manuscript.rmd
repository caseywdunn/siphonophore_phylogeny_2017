...
ggplot(trimmed_SDdata, aes(x = Species, y=-Depth)) + geom_violin() + theme_classic() %>% pdf("trimmed_violinVars.pdf")
...
gheatmap(p, f_cdata, offset = 0.4, width=0.5, colnames_position = 'top', font.size = 1) %>% pdf("overview_ggheatmap_chars.pdf")
```
