...
```
These findings are largely consistent with a previous analysis based on two genes (16S and 18S ribosomal RNA) (Fig. 3) [@Dunn:2005dy]. There is strong support for Cystonectae as sister to all other siphonophores, the codonophorans. We also find strong support for Calycophorae nested within the paraphyletic "Physonectae", and for Apolemidae as sister to all other codonophorans. Multiple nodes that were not resolved in the previous two-gene analysis receive strong support in this 1,071-gene transcriptome analysis. There is strong support for Pyrostephidae as sister to all other non-Apolemid codonophorans. Within the clade that is sister to Pyrostephidae, we find two main clades, Calycophorae and a clade we call Euphysonectae (Fig. 3), which includes the remaining non-Apolemid, non-Pyrostephid physonects. We define Euphysonectae as the clade consisting of *Agalma elegans* and all taxa that are more closely related to it than to *Diphyes dispar*. Within Euphysonectae, we identify Clade A and Clade B (Fig. 3). Clade A comprises siphonophores that all have an involucrum, or fold, that forms around the base of the tentilla [@totton1965synopsis]. This clade also shares the prescence of a descending mantle canal within the nectophores (Fig. S6). Clade B is a group of deep-sea siphonophores found within the bathypelagic. Within Clade B there is low support for the placement of *Erenna richardi*, and more taxon sampling will be required to determine the relationship of species within this clade.
