...
The nectosome can be located in a dorsal or a ventral position, following the orientation framework of @haddock_dunn_pugh_2005. Our ancestral reconstructions for this character (Fig. S5) show that a ventrally-oriented nectosome was the ancestral form in Codonophora, and that a dorsal nectosome has evolved twice independently, in the branch leading to the Agalmatidae *sensu stricto* and the branch leading to the *Bargmannia* species.
