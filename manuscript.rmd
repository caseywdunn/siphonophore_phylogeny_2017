...
#	library( RGraphics )
  ...
  library( phylolm )
	...
	input_file_ml = "agalma/Outfiles/RAxML_bipartitions.alignment.fa"
...
```{r pre_process_species_trees, include=FALSE, cache=TRUE}
	...
	species_tree = 
	  ape::root( 
	    species_tree, 
	    c( "Nematostella_vectensis", "Aiptasia_pallida" ), 
	    resolve.root=TRUE 
	   )

  #medusozoa_node = getMRCA( species_tree, c("Alatina_alata", "Nanomia_bijuga") )
	
  #species_tree = phytools::reroot( species_tree, medusozoa_node )
