...
raw_data$Species[which(raw_data$Species == "Thermopalia")] = "Stephalia sp." ##We should do something about this not corresponding...
raw_data$Species[which(raw_data$Species == "Physonectae sp. 1")] = "Undescribed Sp. L" #Is this correct?
