...
#	pdf("figures_for_AI/figure_3_raw.pdf")
...
NectoPosTree = drop.tree(ultratree, which(!(ultratree$tip.label %in% names(necto_pos))))
make.simmap(NectPosTree, necto_pos, nsim = 100, message=FALSE) -> necto_pos_sim
