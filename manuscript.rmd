...
names(trees)<-c("A. GTR20+FO+R6 ","B. JTT+F+R6","C. WAG+FO+R6")
ggtree(trees) + facet_wrap(~.id, scale="free", ncol=3) +geom_tiplab(size=2) + xlim(0, 2)
