...
When we reconstruct the evolutionary history of sex distribution in siphonophore species, we obtain the following results:
```{r sex_results} 
make.simmap(ultratree, sex, nsim = 100)
``` 
...
```{r nectophore_number_types, echo=F}
